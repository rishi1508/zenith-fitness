      ...
      {stats && (
        <div className="grid grid-cols-4 gap-2">
          {[
            ...
            { icon: <Flame className="w-4 h-4" />, value: `${stats.currentStreak}w`, label: (stats.streakLevel ?? 1) >= 2 ? `${stats.streakLevel}★ Streak` : 'Streak', color: 'text-red-400', bg: 'bg-red-500/10' },
