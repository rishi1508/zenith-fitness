...
import { 
  ...
  Check, Flame, Search,
  ChevronLeft, Trash2, Target,
  Settings, ClipboardList, Plus, Edit3, Sun, Moon
} from 'lucide-react';
import type { Workout, WorkoutTemplate, UserStats, WeeklyPlan, DayPlan, Exercise } from './types';
...
import { HistoryView, ProgressView, SettingsView, ExerciseManagerView, HomeView, ActiveWorkoutView } from './views';
