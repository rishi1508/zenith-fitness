...
import type { Workout, WorkoutExercise, WorkoutSet, WorkoutTemplate, UserStats, WeeklyPlan, DayPlan, Exercise, BodyWeightEntry } from './types';
...
import { HistoryView, ProgressView } from './views';
